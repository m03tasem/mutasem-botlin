...
#tinkerbell
cl = LINETCR.LINE()
cl.login(token="En9wOg00uxXzlNMNwd7b.HKVAQl0Gf6PhpSqzxfl2EW.LY9tiF6SXVRCHyZB0kabSQ3u8EM0AJ9CnC5o2iUk6z4=")
cl.loginResult()
...
targets = []
Bots=[mid]
admin = ["u864bdaa8bd2017aa473ec4195c52f67b"]
owner = ["u864bdaa8bd2017aa473ec4195c52f67b"]
wait = {
    'contact':False,
    'autoJoin':True,
